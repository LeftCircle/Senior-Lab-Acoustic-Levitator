...
m_meshN = 50                   # number of points in side length of square that represents transducer
z_middle = 100
...
pressure matrix and double it. This will probably involve magic numbers.
...
#t_matrix_full = []
p_bottom = np.zeros((len(xyz_m[0][0]),1))
...
for i in range(1): #do half then flip
    i = 2
    #going to flip p matrix?    
